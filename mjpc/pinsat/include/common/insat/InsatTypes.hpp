...
namespace ps
{
    ...
    struct MjpcTraj
    {
        typedef mjpc::iLQGPolicy TrajInstanceType;

        inline long size() const {return disc_traj_.size();}
        inline bool isValid() const {return disc_traj_.size()>0;}
    ...
    struct InsatTraj : public DummyTraj, public BSplineTraj, public MjpcTraj
    {};
